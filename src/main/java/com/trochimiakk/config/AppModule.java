...
public class AppModule extends AbstractModule {
    ...
    protected void configure(){
        ...
        bind(String.class).annotatedWith(Names.named("settings file location"))
                .toInstance(System.getProperty("user.home") + File.separator + ".Flashcards" + File.separator + "settings" + File.separator + "settings.properties");
    ...
    private Properties getProperties(){
        SettingsManager manager = new SettingsManager(System.getProperty("user.home") + File.separator + ".Flashcards" + File.separator + "settings" + File.separator + "settings.properties");
        Properties settings;
        try {
